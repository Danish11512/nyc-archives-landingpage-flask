...
## Development environment and release process
 ...
 - create virtualenv with Flask and landing_page installed into it (latter is installed in
...
install it (`pip install landing_page.tar.gz`), ensure that configuration file exists and
`LANDING_PAGE_SETTINGS` environment variable points to it, ensure that user has access to the
